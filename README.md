...
- **Complex**: 투명 영역은 Transparent Mesh로, 불투명 영역은 Opaque Mesh로 생성.
  (Complex 모드는 Mesh Prefab을 생성해야만 사용할 수 있으며, 생성되는 메쉬 또한 Mesh Prefab에만 저장됩니다)
...
### Mesh Prefab
- **Prefab**: Sprite와 연결된 Prefab입니다.
- **Create/Remove**: Mesh Prefab을 생성하여 Sprite와 연결합니다 / 연결을 끊고 Mesh Prefab을 삭제합니다.
- **Default Transparent Shader**: Mesh Prefab 생성시 사용할 투명 영역에 대한 Shader입니다.
- **Default Opaque Shader**: Mesh Prefab 생성시 사용할 불투명 영역에 대한 Shader입니다.
